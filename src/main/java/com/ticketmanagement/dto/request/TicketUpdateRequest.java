...
/**
 * Ticket guncelleme istegi.
 * Is kurali #6 geregi createdBy alani bu DTO'da yer almaz — degistirilemez.
 * Status degisikligi ayri endpoint uzerinden yapilir (PATCH /status).
 */
